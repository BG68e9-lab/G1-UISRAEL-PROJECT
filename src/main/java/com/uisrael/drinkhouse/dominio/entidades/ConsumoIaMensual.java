...
public class ConsumoIaMensual {
	...
	public ConsumoIaMensual(Long consumoIaMensualId, String mesAnio, Long tokensConsumidos, Double costoEstimado,
	...
	public Long getConsumoIaMensualId() {
		return consumoIaMensualId;
	}

	public void setConsumoIaMensualId(Long consumoIaMensualId) {
		this.consumoIaMensualId = consumoIaMensualId;
	}
