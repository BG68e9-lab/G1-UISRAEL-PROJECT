...
public class Producto {
	...
	public Producto(Long productoId, String nombre, String marca, String tipo, String descripcion,
			BigDecimal costoPromedio, BigDecimal margenGanancia, BigDecimal precioVenta, Boolean precioPersonalizado,
			Integer stockActual, Integer stockMinimo, Boolean visibleSinStock, String origenIdentificacion) {
