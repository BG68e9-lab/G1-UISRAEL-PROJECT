...
public class TokensIaNegocio {
	...
	public TokensIaNegocio(Long tokenIaNegocioId, Integer negocioId, String claveConfiguracion, String valorToken,
	...
	public Long getTokenIaNegocioId() {
		return tokenIaNegocioId;
	}

	public void setTokenIaNegocioId(Long tokenIaNegocioId) {
		this.tokenIaNegocioId = tokenIaNegocioId;
	}
